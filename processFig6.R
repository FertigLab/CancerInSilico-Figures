...
fig6_single_cell_types <- sapply(fig6_two_cell_types_single_cell_RNAseq, getType)
fig6_single_cell_phases <- sapply(fig6_two_cell_types_single_cell_RNAseq, getPhase)
